...
namespace Manhood
{
    internal static class Extensions
    {
        ...
        public static bool ParseParameterList(this string str, out List<string> list)
        {
            ...
            var reader = new CharReader(str, 0);
            while(!reader.EndOfString)
            {
                var c = reader.ReadChar();
                if (c != '[') continue;
                var end = str.FindClosingSquareBracket(reader.Position);
        ...
        public static bool PermitsCap(this char c)
        {
            ...
            var uni = char.GetUnicodeCategory(c);
